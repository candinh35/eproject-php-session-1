...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Nunito:wght@200;500&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;1,100;1,200;1,300;1,400;1,500&family=Roboto:ital,wght@0,300;0,400;0,500;0,700;1,100;1,300;1,400;1,500&display=swap"
          rel="stylesheet">
...
<header class="header ">
    <nav class="flex justify-between items-center bg-zinc-100 h-24">
        ...
        <div class="lg:hidden block">
            ...
            <div class="nav_mobile1 fixed top-0 left-0 bottom-0 w-80 max-w-full bg-white z-20 -translate-x-80">
                <div class="relative left-6 mb-5">
                    <input class="rounded-2xl focus:outline-none w-56 h-8 mt-11 p-4 pb-5 f bg-zinc-200" type="text"
        ...
        <div class="relative left-14 hidden lg:block">
            <input class="rounded-2xl focus:outline-none w-80 h-8  p-4 pb-5 f bg-zinc-200" type="text"
                   placeholder="Tìm kiếm...">
            <i class="absolute right-3 top-2.5 fa-solid fa-magnifying-glass"></i>
        </div>
        <div class="w-52 h-14 lg:mr-0 mr-16">
            <a href="index.php"><img src="<?php echo $logo['logo']; ?>" alt="logo-mona-furniture-14"
...
<div class="container lg:w-11/12 w-full  lg:mx-auto mx-0 mt-14">
    <section>
        <div class="product flex flex-row mx-7">
            <div class="flex mt-8 gap-2 w-4/12">
                                ...
                                $i = 0;
                                        ...
                                        foreach ($productList as $product):
                                            ...
                                            <li class="flex gap-4 items-center mb-3 fa-border p-3">
                                                <a href=""><img class="w-20 h-20 " src="<?php echo $product['image'] ?>"
                                                                alt=""></a>
                                                <div>
                                                    <h4 class="text-xl product-title hover:text-amber-600 w-40"><a
                                                                href=""><?php echo $product['name'] ?></a></h4>
            ...
            <div class="product-description">
                <div class="flex flex-row ">
                    <div class="product-image pr-24 ">
                        <img class="" src="<?php echo BASE_URL . $result['image']; ?>" alt="" width="300">
                    </div>
                    <div>
                        ...
                        <div class="product-short-description">
                            <ul class="list-disc">
                                <li>Bộ ghế sofa SF32 mang kiểu dáng hiện đại, trẻ trung, tạo điểm nhấn nổi bật cho toàn
                                    bộ kiến trúc văn phòng làm việc thêm phong cách, lịch lãm.
                                </li>
                                <li>Bộ ghế được&nbsp;bọc PVC cao cấp, gồm có 01 băng dài bề thế, 02 ghế đơn tiện nghi
                                </li>
                ...
                $i++;
                    ...
                    <div class="product_item">
                        <a href="detail.php?id=<?php echo $product1['id'] ?>">
                            <img src="<?php echo BASE_URL . $product1['image']; ?>" width="300"
                                 class="ml-7 product_sofa">
                        </a>
